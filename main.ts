sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    hotdog.setPosition(randint(0, 120), randint(0, 120))
    info.startCountdown(10)
    gochira.changeScale(0.1, ScaleAnchor.Middle)
})
let hotdog: Sprite = null
let gochira: Sprite = null
scene.setBackgroundColor(7)
gochira = sprites.create(img`
    . . . . f f f f f . . . . . . . 
    . . . f e e e e e f . . . . . . 
    . . f d d d d e e e f f . . . . 
